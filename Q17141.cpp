//Make combination of points to place the virus
//Then BFS for each and find out how long it takes for it to spread
#include <bits/stdc++.h>
using namespace std;
...
int bfs(){
    int time = 0;
    int current_empty = empty_count - place_count;
    queue<point> q;
